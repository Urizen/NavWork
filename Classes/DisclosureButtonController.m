...
- (void) viewDidLoad {
	...
	NSArray *array = [[NSArray alloc] initWithObjects:@"Toy Story", @"A Bug's Life", @"Toy Story 2", @"Monsters, Inc.", @"Finding Nemo",
					  @"The Incredibles", @"Cars", @"Ratatouille", @"WALL-E", @"Up", @"Toy Story 3", @"Cars 2", @"The Bear and the Bow", 
					  @"Newt", nil];
...
- (void) viewDidUnload {
	...
	self.list = nil;
	[childController release]; //try removing this item if no explenation is given
	childController = nil;
}
...
#pragma mark -
#pragma mark Table Delegae Methods
